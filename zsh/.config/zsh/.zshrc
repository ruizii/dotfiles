...
fpath=(~/Code/repos/zsh-completions/src ~/Code/repos/zshcompletions $fpath)
...
zstyle ':completion:::::descriptions' format '%F{blue}-- %d :3 --%f'
zstyle ':completion:*:warnings' format '%F{red}-- No matches found :c --%f'
zstyle ':completion:*:default' list-colors ${(s.:.)ZLS_COLORS} "ma=38;5;253;48;5;23"
...
# Re-bind fzf keys after compinit and arch-debian.zsh (which loads the
# completion system plugins) so these take precedence
