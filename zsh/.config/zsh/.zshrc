...
export PATH="$PATH:$HOME/bin:$HOME/.local/bin:$HOME/.cargo/bin:$HOME/.local/share/go/bin:$HOME/.local/share/shitty-ctftools/bin:$HOME/.local/share/nvim/mason/bin:$HOME/.ghcup/bin/:$HOME/.local/share/zig-linux-x86_64-0.14.0/"
